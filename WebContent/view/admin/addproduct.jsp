              ...
              <div class="card-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/product/add">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-1" placeholder="Name" name="product-name">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="the-date" placeholder="Date" name="product-day">
                  </div>
	                <div class="form-group">
                    ...
                    <div class="form-group">
	                 ...
	                 <div class="form-group">
		                ...
		                <input type="text" class="form-control" placeholder="Sale ... %" name="product-discount">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="input-1" placeholder="name" name="product-image">
                  </div>
