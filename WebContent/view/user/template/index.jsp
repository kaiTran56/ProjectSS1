			...
			<div class="row">
				<div class="col-lg-3">
					<div class="product-large set-bg"
						data-setbg="${pageContext.request.contextPath}/view/user/template/img/products/women-large.jpg">
						<h2>Women’s</h2>
			...
			<div class="row">
				...
				<div class="col-lg-3 offset-lg-1">
					<div class="product-large set-bg m-large"
						data-setbg="${pageContext.request.contextPath}/view/user/template/img/products/man-large.jpg">
						<h2>Men’s</h2>
						<a href="#">Discover More</a>
					</div>
				</div>
